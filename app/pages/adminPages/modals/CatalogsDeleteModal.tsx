...
const CatalogsDeleteModal: React.FC<Props> = ({ isShow, handleClose }) => {
	return (
		<Modal minWidth={866} isShow={isShow} handleClose={handleClose}>
			...
			<p className="modal__delete-text">
				Вы хотите удалить справочник «Области», вы уверены в удаление?
			</p>
...
export default CatalogsDeleteModal;
